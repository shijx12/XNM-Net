...
```
 python3.6 preprocess_scene.py --input-scene /data/sjx/CLEVR_v1.0/scenes/CLEVR_train_scenes.json --output-vocab-json /data/sjx/CLEVR-Exp/data/vocab.json --output-scene /data/sjx/CLEVR-Exp/data/train_scenes.pt
```

4. val scenes. update vocab with edge_token_to_idx, which will actually not change it.
```
 python3.6 preprocess_scene.py --input-scene /data/sjx/CLEVR_v1.0/scenes/CLEVR_val_scenes.json --output-vocab-json /data/sjx/CLEVR-Exp/data/vocab.json --output-scene /data/sjx/CLEVR-Exp/data/val_scenes.pt
```
